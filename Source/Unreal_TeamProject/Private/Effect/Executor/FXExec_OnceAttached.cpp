...
void UFXExec_OnceAttached::Execute_Attached(IFXService& Service, const UFXData* Data, const FFXCueParams_Attached& Param)
{
	if (!Data)
	{
	...
	UNiagaraComponent* FXComponent = Service.SpawnOnceAttached
	(
